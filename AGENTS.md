...
- `ANTHROPIC_API_KEY` is only required for `npm run generate-theme`, not for normal local development. Optional `TYPESAFE_API_KEY` enables Jev taste ranking among safe candidates.
