...
This is why we must explore the right enclosures and interfaces for agents. We'll soon realize all these CLI tools are not primarily for the humans. People giving the formless thing a shape so they can understand what it does.
