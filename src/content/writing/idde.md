...
2008 to 2015 were formative years as a designer. I immersed myself in as many tools as possible and find ways to subvert them to build something; some of my favorites being Quartz Composer, Xcode, Framer.js, and coding on TextMate 2. Blending design tools with ways to build, I became enamored with the concept of an Integrated Design (and) Development Environment (IDDE).

The traditional IDE is a suite of tools and features needed for you to build and ship software. I never understood why a design wasn't a part of it. Funny story; when I interviewed with Apple's Xcode team many years ago, one of the interviewers asked me what is a wild idea I would propose doing. "I would buy Sketch 2.0 and make it the new Interface Builder." This probably killed the interview for me.
...
There are forces of nature in play accelerating this change, and it’s more timely than ever. The first are the adoption of Large Language Models (LLMs)—no surprise if you've been following tech trends in the past 12-18 months. I don't think LLMs is a fad or hype cycle but a foundational change. Because of the complexity of these systems, drawing UI isn't sufficient enough to design for something so dynamic. LLMs are only one example of a dynamic system being a core aspect of software. With innovations like Open Intepreter’s 01, multiple device interaction is another complex system the drawing software cannot comprehend.

Second, the the skill range of designers and engineers are expanding through natural skill building or augmentation with AI workflows. A designer who may not be comfortable with coding can hack something together through natural language. It also means a software engineer who may not like front-end work an get help with AI tools to close the skill gap. Both disciplines are getting more-and-more comfortable within their traditional workflows. According to Figma, 30% of their users are developers.
...
The concept of merging design and developer tools sounds great, but infusing the workflows can’t be slapped on. Regardless of how innovative or cool your product is, existing human behaviors and adoption will be the biggest competitor to your product’s success. Remember, the two most opinionated of people about workflows on the planet are designers and developers. If the workflows are well-considered and evolved, adoption can occur.
